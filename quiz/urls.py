...
from .views import QuizListView, CategoriesListView,\
    ...
    QuizMarkingDetail, QuizDetailView, QuizTake, index, login_user, logout_user, about_pls
...
urlpatterns = [
    ...
    #All About Plastic menu
    url(regex=r'^about_pls/$', view=about_pls, name='about_pls'),
