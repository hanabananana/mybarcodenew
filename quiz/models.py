...
class Question(models.Model):
    ...
    figure = models.ImageField(upload_to='quiz/images/',
                               blank=True,
                               null=True,
    ...
    sourceWhere = models.CharField(max_length=1000,
                                   blank=True,
                                   help_text=_("Where the source of the data "
                                               "come from"),
                                   verbose_name=_('sourceWhere'))
